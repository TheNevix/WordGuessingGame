<script>
  ...
  import { username, profilePicUrl, bannerColor, userTags, activeTag, isGuest, isWaiting, matchData } from '$lib/stores.js';
  import { connectToHub, cancelWaiting } from '$lib/hub.js';
